...
export default function HomePage({ dict, lang }: { dict: Dictionary, lang: string }) {
  ...
  const barsData = [
    { name: "Le Velours Rouge", location: "Vieux-Port, Montréal", status: dict.bars.statusVeryActive, color: "from-[#FFB566] to-[#D55A2F]", users: `138 ${dict.bars.online}`, description: lang === 'en' ? "An elegant cocktail lounge with velvet seats and dim lighting, perfect for intimate encounters over craft drinks." : "Un élégant salon à cocktails avec des sièges en velours et un éclairage tamisé, parfait pour des rencontres intimistes autour de boissons artisanales.", ambiance: "Cocktails & Lounge", age: "20-30" },
    { name: "L'Éclipse", location: "Plateau Mont-Royal, Montréal", status: dict.bars.statusActive, color: "from-[#4A90E2] to-[#1D4E89]", users: `91 ${dict.bars.online}`, description: lang === 'en' ? "A vibrant nightclub with resident DJs, neon lights and an electric atmosphere that keeps the crowd dancing until dawn." : "Un club vibrant avec des DJs résidents, des néons et une atmosphère électrique qui fait danser la foule jusqu'à l'aube.", ambiance: "Clubbing & DJ Sets", age: "22-30" },
    { name: "La Terrasse Boréale", location: "Saint-Roch, Québec", status: dict.bars.statusVeryActive, color: "from-green-400 to-emerald-700", users: `107 ${dict.bars.online}`, description: lang === 'en' ? "A cozy neighborhood bar with a stunning rooftop terrace and an impressive selection of local microbrewery beers." : "Un bar de quartier chaleureux avec une magnifique terrasse sur le toit et une impressionnante sélection de bières de microbrasseries locales.", ambiance: "Microbrasseries & Terrasse", age: "21-35" },
    { name: "Le Campus Café", location: "Quartier universitaire, Québec", status: dict.bars.statusActive, color: "from-purple-400 to-fuchsia-700", users: `72 ${dict.bars.online}`, description: lang === 'en' ? "The ultimate hangout spot near campus. Board games, affordable drinks and the perfect vibe to meet fellow students." : "Le spot incontournable près du campus. Jeux de société, consommations abordables et l'ambiance parfaite pour rencontrer d'autres étudiants.", ambiance: "Étudiante & Conviviale", age: "18-24" }
  ];

  const eventsData = [
    { name: "Nuit Polaire", date: "15 " + (lang === 'en' ? 'March' : 'Mars') + " 2026", location: "Parc des Lumières, Québec", color: "from-highlight to-primary", description: lang === 'en' ? "The biggest winter night gathering of the year. Join us at the heart of the festival for a special Baromètre dating zone from 6pm to midnight. Open air dance floor and ice bars." : "Le plus grand rassemblement nocturne hivernal de l'année. Rejoignez-nous au cœur du festival pour une zone spéciale de rencontres Baromètre de 18h à minuit. Piste de danse en plein air et bars de glace.", ambiance: lang === 'en' ? "Open air festival" : "Festival en plein air", age: "18-40" },
    { name: "La Grande Éclipse", date: "22 " + (lang === 'en' ? 'March' : 'Mars') + " 2026", location: "L'Éclipse, Montréal", color: "from-primary to-highlight", description: lang === 'en' ? "The biggest student party of the year. Baromètre will be the official app of the night. Free shots for the first matches verified on site!" : "La plus grande soirée étudiante de l'année. Baromètre sera l'application officielle de la soirée. Tournée de shots offerts pour les premiers matchs validés sur place !", ambiance: lang === 'en' ? "Student storm" : "Tempête étudiante", age: "18-25" },
    { name: "Fréquences Hivernales", date: (lang === 'en' ? 'April' : 'Avril') + " 2026", location: "Vieux-Port, Québec", color: "from-[#4A90E2] to-highlight", description: lang === 'en' ? "Warm up the atmosphere! A special Baromètre activation with exclusive access to the VIP lounge by matching. Come dance under the stars to the rhythm of electronic music." : "Réchauffez l'atmosphère! Une activation spéciale Baromètre avec accès exclusif au lounge VIP en matchant. Venez danser sous les étoiles au rythme de la musique électronique.", ambiance: lang === 'en' ? "Electronic & Winter" : "Électronique & Hivernal", age: "20-35" }
  ];
