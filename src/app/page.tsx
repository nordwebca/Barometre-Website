...
const barsData = [
  { name: "La Distillerie No.1", location: "Quartier Latin, Montréal", status: "Très actif", color: "from-[#FFB566] to-[#D55A2F]", users: "142 en ligne", description: "Célèbre pour ses cocktails servis dans des pots Masson, la Distillerie est incontournable pour les étudiants et jeunes professionnels.", ambiance: "Cocktails & Party", age: "18-25 ans" },
  { name: "Club Moka", location: "Centre-ville, Montréal", status: "Actif", color: "from-[#4A90E2] to-[#1D4E89]", users: "85 en ligne", description: "Un des clubs les plus branchés de la métropole avec une large piste de danse, des cocktails raffinés et de la musique électro-house.", ambiance: "Clubbing & VIP", age: "20-30 ans" },
  { name: "Le Sacrilège", location: "Saint-Jean-Baptiste, Québec", status: "Très actif", color: "from-green-400 to-emerald-700", users: "115 en ligne", description: "Bar de quartier chaleureux et historique avec une magnifique cour intérieure et une impressionnante sélection de bières de microbrasserie.", ambiance: "Chill & Microbrasseries", age: "22-35 ans" },
  { name: "Pub Universitaire", location: "Campus ULaval, Québec", status: "Actif", color: "from-purple-400 to-fuchsia-700", users: "64 en ligne", description: "Le point de rassemblement classique au cœur du campus. Billards, pichets abordables et l'endroit parfait pour décompresser après les cours.", ambiance: "Étudiante & Festive", age: "18-24 ans" }
];

const eventsData = [
  { name: "Festival Nordique", date: "15 Mars 2026", location: "Parc de la Francophonie, Québec", color: "from-highlight to-primary", description: "Le plus grand rassemblement nordique de l'année. Rejoignez-nous au cœur du festival pour une zone spéciale de rencontres Baromètre de 18h à minuit. Piste de danse en plein air et bars de glace.", ambiance: "Festival en plein air", age: "18-40 ans" },
  { name: "Soirée Moka Club", date: "22 Mars 2026", location: "Club Moka, Montréal", color: "from-primary to-highlight", description: "La plus grande soirée étudiante de l'année. Baromètre sera l'application officielle de la soirée. Tournée de shots offerts pour les premiers matchs validés sur place !", ambiance: "Tempête étudiante", age: "18-25 ans" },
  { name: "Igloofest Québec", date: "Avril 2026", location: "Vieux-Port, Québec", color: "from-[#4A90E2] to-highlight", description: "Réchauffez l'atmosphère! Une activation spéciale Baromètre avec accès exclusif au lounge VIP en matchant. Venez danser sous les étoiles au rythme de la musique électronique.", ambiance: "Électronique & Hivernal", age: "20-35 ans" }
];
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'py-4 glass shadow-lg' : 'py-6'}`}>
        <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-10">
            <a href="#concept" className="font-semibold text-white/90 hover:text-highlight transition-colors">Le Concept</a>
            <a href="#features" className="font-semibold text-white/90 hover:text-highlight transition-colors">Fonctionnalités</a>
            <a href="#bars" className="font-semibold text-white/90 hover:text-highlight transition-colors">Lieux</a>
            <a href="#faq" className="font-semibold text-white/90 hover:text-highlight transition-colors">FAQ</a>
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full p-8 flex flex-col gap-6 glass border-t border-[#5B628F]/20 md:hidden">
            ...
            <a href="#bars" className="font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>Lieux</a>
            <a href="#faq" className="font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>FAQ</a>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="p-6">
              ...
              <p className="text-lg text-muted font-medium">Lieux Partenaires</p>
            </div>
            <div className="p-6 pt-10 md:pt-6">
              <div className="flex justify-center mb-4"><Heart className="text-highlight" size={32} /></div>
              <h3 className="text-5xl font-extrabold text-white mb-2">12k</h3>
              <p className="text-lg text-muted font-medium">Matchs en direct</p>
            </div>
            <div className="p-6 pt-10 md:pt-6">
              <div className="flex justify-center mb-4"><Clock className="text-highlight" size={32} /></div>
              <h3 className="text-5xl font-extrabold text-white mb-2">3 min</h3>
              <p className="text-lg text-muted font-medium">Temps avant de se dire bonjour</p>
            </div>
            <div className="p-6 pt-10 md:pt-6">
              <div className="flex justify-center mb-4"><Activity className="text-highlight" size={32} /></div>
              <h3 className="text-5xl font-extrabold text-white mb-2">10k+</h3>
              <p className="text-lg text-muted font-medium">Utilisateurs actifs</p>
            </div>
          </div>
        </div>
      </section>

      <section className="max-w-7xl mx-auto px-8 py-24" id="security">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 w-full relative">
            ...
            <div className="glass-card !p-8 border border-highlight/20 relative overflow-hidden">
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h4 className="text-xl font-bold text-white mb-1">Lieux sécurisés et publics</h4>
                  <p className="text-muted text-sm leading-relaxed">Les matchs ne s'activent que dans des environnements publics partenaires (bars, festivals) avec du personnel présent. Pas de rendez-vous dans des ruelles sombres.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <h4 className="text-xl font-bold text-white mb-1">Profils vérifiés</h4>
                  <p className="text-muted text-sm leading-relaxed">Un "Selfie de sécurité" est requis régulièrement pour garantir que vous parlez bien à la personne sur les photos. Les faux profils sont bannis.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold text-white mb-1">Radar furtif optionnel</h4>
                  <p className="text-muted text-sm leading-relaxed">Vous ne voulez pas être vu ce soir ? Activez le mode fantôme pour disparaître du radar Baromètre en un seul clic.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Rencontrez-vous l'esprit <span className="text-highlight">tranquille</span></h2>
            <p className="text-xl text-muted leading-relaxed mb-8">
              Puisque Baromètre encourage les rencontres physiques immédiates, la sécurité de notre community est notre priorité absolue. Nous mettons tout en œuvre pour que l'expérience soit fun et sans danger.
            </p>
            <ul className="space-y-4 text-left inline-block lg:block">
              <li className="flex items-center gap-3 text-white/90 font-medium">
                <span className="w-6 h-6 rounded-full bg-green-500/20 text-green-400 flex items-center justify-center text-sm">✓</span> Signalement et blocage faciles
              </li>
              <li className="flex items-center gap-3 text-white/90 font-medium">
                <span className="w-6 h-6 rounded-full bg-green-500/20 text-green-400 flex items-center justify-center text-sm">✓</span> Partenaires sensibilisés
              </li>
              <li className="flex items-center gap-3 text-white/90 font-medium">
                <span className="w-6 h-6 rounded-full bg-green-500/20 text-green-400 flex items-center justify-center text-sm">✓</span> Bouton "Ange Gardien" in-app
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="bg-bg-darker py-32 border-t border-[#5B628F]/20 relative overflow-hidden">
      ...
      <section className="bg-bg-dark border-t border-[#5B628F]/20 py-32 relative" id="bars">
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold text-highlight mb-6 border border-highlight/30 glass">
              ...
              <span>Lieux Actifs</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Nos Bars <span className="text-highlight">Partenaires</span></h2>
            <p className="text-xl text-muted">Connectez-vous dès maintenant dans ces établissements pour découvrir qui s'y trouve.</p>
          </div>
                  ...
                  <div className="flex flex-col items-start">
                    <span className="flex items-center gap-2 text-xs font-semibold mb-1 w-full">
                      <span className="relative flex h-2 w-2">
                        <span className={`absolute inline-flex h-full w-full rounded-full ${bar.status === 'Très actif' ? 'bg-[#FFB566] animate-ping' : 'bg-[#4A90E2]'} opacity-75`}></span>
                        <span className={`relative inline-flex rounded-full h-2 w-2 ${bar.status === 'Très actif' ? 'bg-[#D55A2F]' : 'bg-[#1D4E89]'}`}></span>
                      </span>
                      {bar.status}
                    </span>
          ...
          <div className="mt-12 text-center">
            <button onClick={() => setIsMapModalOpen(true)} className="btn btn-secondary px-8 py-3 group">
              Voir la carte complète des lieux <ChevronRight size={16} className="inline ml-1 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-bg-dark to-bg-darker border-t border-[#5B628F]/20 py-32" id="faq">
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Questions <span className="text-highlight">Fréquentes</span></h2>
            <p className="text-xl text-muted">Tout ce que vous devez savoir avant de swiper en vrai.</p>
          </div>

          <div className="grid gap-6">
            {[
              {
                q: "Dois-je payer pour matcher ?",
                a: "L'application Baromètre est entièrement gratuite pour matcher et envoyer des messages. L'accès aux lieux partenaires est soumis à la politique de chaque établissement."
              },
              {
                q: "L'application marche-t-elle si je ne suis pas dans un bar ou événement partenaire ?",
                a: "Non. Le radar Baromètre ne s'active que lorsque vous êtes géolocalisé à l'intérieur d'une zone partenaire. C'est ce qui garantit que vos matchs sont bien réels et sur place."
              },
              {
                q: "Comment l'application sait que je suis bien dans le bar ?",
                a: "Nous utilisons un système de géolocalisation fine et de validation par périmètre géographique. Dans les festivals, nous utilisons même des boîtiers Bluetooth pour une précision maximale."
              },
              {
                q: "Mon profil est-il visible partout ?",
                a: "Absolument pas. Votre profil n'apparaît que sur le radar du lieu précis où vous vous trouvez, et seulement pour les personnes qui s'y trouvent également à l'instant T."
              },
              {
                q: "Que faire si quelqu'un me dérange après un match ?",
                a: "Notre bouton 'Signaler' vous permet de bloquer instantanément l'utilisateur in-app. De plus, nos lieux partenaires ont un protocole pour vous assister physiquement au besoin (dispositif 'Ange Gardien')."
              }
            ].map((faq, i) => (
          ...
          <div className="mt-12 text-center p-8 rounded-3xl bg-gradient-to-r from-highlight/10 to-primary/10 border border-highlight/20 flex flex-col items-center">
            ...
            <p className="text-muted mb-6">Notre équipe est là pour vous répondre rapidement.</p>
            <button onClick={() => setIsContactModalOpen(true)} className="btn btn-secondary px-8 py-3">Nous contacter</button>
          </div>
        </div>
      </section>

      <section className="bg-bg-darker py-32 border-t border-[#5B628F]/20 relative" id="events">
      ...
      <footer className="bg-bg-darker pt-16 pb-8 border-t border-[#5B628F]/20 mt-auto px-8">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-[#5B628F]/20 gap-4">
          ...
          <p className="text-sm text-center">
            Développé avec <Heart size={14} className="text-highlight inline mx-1" /> par l'équipe <a href="https://nordweb.ca" target="_blank" rel="noopener noreferrer" className="text-highlight font-bold hover:underline">NordWeb</a>
          </p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="glass-card relative w-full max-w-lg z-10 animate-in fade-in zoom-in duration-300">
            ...
            <div className="mb-8 text-center">
              ...
              <h3 className="text-3xl font-bold text-white mb-2">Contactez-nous</h3>
              <p className="text-muted">Une question, un partenariat ? On vous répond vite.</p>
            </div>

            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setIsContactModalOpen(false); alert("Message envoyé ! (Ceci est une démo)"); }}>
              <div>
          ...
          <div className="glass-card relative w-full max-w-5xl h-[80vh] z-10 animate-in fade-in zoom-in duration-300 p-2 flex flex-col">
            <div className="flex justify-between items-center mb-4 px-4 pt-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-2xl font-bold text-white">Carte des Lieux Actifs</h3>
              </div>
              <button
                onClick={() => setIsMapModalOpen(false)}
          ...
          <div className="glass-card relative w-full max-w-lg z-10 animate-in fade-in zoom-in duration-300 border border-highlight/40">
            ...
            <div className="bg-[#192030]/60 rounded-2xl p-6 border border-[#5B628F]/20 space-y-5 mb-8">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <h4 className="text-xs text-muted uppercase tracking-wider font-bold mb-2">Ambiance</h4>
                ...
                <div>
                  <h4 className="text-xs text-muted uppercase tracking-wider font-bold mb-2">Âge moyen</h4>
              ...
              <div className="pt-4 border-t border-[#5B628F]/20">
                <h4 className="text-xs text-muted uppercase tracking-wider font-bold mb-2">Description</h4>
            ...
            <button className="btn btn-primary w-full py-4 text-lg shadow-lg" onClick={() => setSelectedLocation(null)}>
              Ouvrir l'application sur place <ChevronRight className="ml-2" />
            </button>
          </div>
        </div>
      )}
